...
startRouteBtn.addEventListener("click", () => {
  ...
  if (!navigator.geolocation) {
    statusDiv.textContent = "La geolocalización no está disponible en este navegador.";
    return;
  }
  ...
  watchId = navigator.geolocation.watchPosition(
    (position) => {
      ...
      statusDiv.textContent = `Ruta activa. Ubicación capturada correctamente para el autobús ${selectedBus}.`;
      console.log({
